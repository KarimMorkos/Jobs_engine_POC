...
namespace CV
{
    public class YourVerCard_Step2_Page
    {
        #region PageObjects
        ...
        [FindsBy(How = How.XPath, Using = "//*[@id='validated_form']/div/div[3]/div[2]/div[2]/div/input[2]")]
        public IWebElement _HaveCreditNo;

        [FindsBy(How = How.XPath, Using = "//*[@id='validated_form']/div/div[3]/div[2]/div[3]/input[1]")]
        ...
        public YourVerCard_Step2_Page(IWebDriver driver)
        {
